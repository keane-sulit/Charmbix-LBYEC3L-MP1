/* [LBYEC3L] Machine Problem 1 - 24-hour Clock
* ===========================
...
* ===========================
* Description:
* This program is a firmware for a 24-hour clock circuit HHMM that 
* has an initial time of 13:30. Seven-segment displays are used to 
